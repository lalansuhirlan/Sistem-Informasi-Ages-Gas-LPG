      ...
      <div class="content-wrapper">
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>Inventaris Barang Gudang</h1>
              </div>
              <div class="col-sm-6">
                          ...
                          <hr>
                            <div class="table-responsive">
                              <table class="table table-bordered" id="example2" width="100%" cellspacing="0">
                                ...
                                <tr>
                                 ...
                                 <tbody>
                                    <?php
                                     ...
                                     $no=0;
                                     $query=mysqli_query($conn, "SELECT * FROM tbl_gudang ");
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-center">
                                       <button type="button" class="btn btn-info" data-toggle="modal" 
                                            data-target="#modal-edit<?php echo $row['id_gudang']?>">
                                             Edit
                                          </button>
                                    
                                          <button type="button" class="btn btn-danger" data-toggle="modal"
                                           data-target="#modal-hapus<?php echo $row['id_gudang']?>">
                                             Delete
                                           </button>
                                    </td>  
                                  </tr>
                               ...
                               <!-- Modal Edit -->
                                  <div class="modal fade" id="modal-edit<?php echo $row['id_gudang']?>">
                                            <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                ...
                                                <!-- form start -->
                                                <form action="gudang/edit.php" method="post">
                                                    <div class="card-body">
                                                      <div class="form-group">
                                                        <label for="exampleInputEmail1">Kode Barang</label>
                                                        <input type="hidden" name="id_gudang" value="<?php echo $row ['id_gudang']?>">
                                                        <input type="text" class="form-control" name="kode_barang" 
                                                          placeholder="masukan Kode Barang" value="<?php echo $row['kode_barang']?>" disabled>
                                                      </div>
                                                      ...
                                                      <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          placeholder="Masukan Kondisi Barang" value="<?php echo $row['kondisi']?>">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          placeholder="Masukan Tangal masuk barang" value="<?php echo $row['tanggal_masuk']?>" disabled>
                                                        </div>

                                                        <div class="form-group">
                                                          <label for="exampleInputPassword1">Tanggal Update</label>
                                                          <input type="date" class="form-control" name="tanggal_update" 
                                                          placeholder="Masukan Tanggal Update" value="<?php echo $row['tanggal_update']?>">
                                                        </div>

                                                        <div class="form-group">
                                                          <label for="exampleInputPassword1"> Keterangan</label>
                                                          <input type="text" class="form-control" name="keterangan" 
                                                          placeholder="Masukan Keterangan Barang" value="<?php echo $row['keterangan']?>">
                                                        </div>
                                          ...
                                          <!-- /.modal -->
                                            ...
                                            <!-- /.modal Hapus -->
                                          <div class="modal fade" id="modal-hapus<?php echo $row['id_gudang']?>">
                                                ...
                                                <form action="hapus.php" method="post">
                                                    <div class="card-body">
                                                      <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="id_pangkalan" value="<?php echo $row ['id_kantor']?>">
                                                        <input type="text" class="form-control" name="nama_barang" 
...
<!-- Modal Tambah -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
             <!-- form start -->
             <form action="gudang/tambah.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kode Barang</label>
                  ...
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal Masuk</label>
                    <input type="date" class="form-control" name="tanggal_masuk" placeholder="Masukan Tanggal Masuk Barang">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal update</label>
                    <input type="date" class="form-control" name="tanggal_update" placeholder="Masukan Tanggal Update Barang">
                  </div>
