                          ...
                          <hr>
                            <div class="table-responsive">
                              <table class="table table-bordered" id="example2" width="100%" cellspacing="0">
                                ...
                                <tr>
                                 ...
                                 <tbody>
                                    <?php
                                     ...
                                     $no=0;
                                     $query=mysqli_query($conn, "SELECT * FROM tbl_truk ");
                                  ...
                                  <tr>
                                    ...
                                    <td class="text-center">
                                       <button type="button" class="btn btn-info" data-toggle="modal" 
                                            data-target="#modal-edit<?php echo $row['id_truk']?>">
                                             Edit
                                          </button>
                                    
                                          <button type="button" class="btn btn-danger" data-toggle="modal"
                                           data-target="#modal-hapus<?php echo $row['id_truk']?>">
                                             Delete
                                           </button>
                                    </td>  
                                  </tr>
                               ...
                               <!-- Modal Edit -->
                                  <div class="modal fade" id="modal-edit<?php echo $row['id_truk']?>">
                                                ...
                                                <form action="edit.php" method="post">
                                                    <div class="card-body">
                                                      <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="id_kategori" value="<?php echo $row ['kode_barang']?>">
                                                        <input type="text" class="form-control" name="nama_barang" 
                                                          placeholder="masukan Kategori" value="<?php echo $row['kode_barang']?>">
                                                      </div>
                                          ...
                                          <!-- /.modal -->
                                            ...
                                            <!-- /.modal Hapus -->
                                          <div class="modal fade" id="modal-hapus<?php echo $row['id_truk']?>">
