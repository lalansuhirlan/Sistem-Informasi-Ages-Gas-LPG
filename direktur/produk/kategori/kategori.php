                                    ...
                                    <?php
                                        ...
                                        <tr>
                                          ...
                                          <button type="button" class="btn btn-info" data-toggle="modal" 
                                            data-target="#modal-edit<?php echo $row['id_kategori']?>">
                                             Edit
                                          </button>
                                          <button type="button" class="btn btn-danger" data-toggle="modal"
                                           data-target="#modal-hapus<?php echo $row['id_kategori']?>">
                                             Delete
                                           </button>
                                          </td>
                                        ...
                                        <div class="modal fade" id="modal-edit<?php echo $row['id_kategori']?>">
