           ...
           <div class="table-responsive">
            ...
            <tbody>
               ...
               ?>
                 <tr>
                  ...
                  <td>
                      <button type="button" class="btn btn-info" data-toggle="modal"
                            data-target="#modal-lg-edit<?php echo $row['id_produk']?>">
                          Edit
                          </button>
                 ...
                 <div class="modal fade" id="modal-lg-edit<?php echo $row['id_produk']?>">
                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                        <label >kode produk</label>
                                          <input type="hidden" name="id_produks" value="<?php echo $row ['id_produk']?>">
                                          <input type="text" class="form-control" name="kode" 
                                           placeholder="masukan Kode" value="<?php echo $row['kode_produk']?>" readonly>
                                       </div>
                                       <div class="form-group">
                                          <label >Nama Produk</label>
                                          <input type="text" class="form-control" name="nama_produk" 
                                          placeholder="Masukan Nama Produk" value="<?php echo $row['nama_produk']?>">
                                       </div>
                                       <div class="form-group">
                                          <label >Kategori Produk</label>
                                          <select name="id_kategori" class="form-control" required>
                                            <option value="<?php echo $row['id_kategori']?>" selected disabled>-Pilih Kategori-</option>
                                            <?php 
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select name="id_satuan" class="form-control" required>
                                            <option value="<?php echo $row['id_satuan']?>" selected disabled>-Pilih Satuan-</option>
                                            <?php 
                                        ...
                                        <div class="form-group">
                                          ...
                                          placeholder="Masukan Harga Beli" value="<?php echo $row['harga_beli']?>">
                                       </div>
                                       <div class="form-group">
                                          <label >Harga Jual</label>
                                          <input type="number" class="form-control" name="harga_jual" 
                                          placeholder="Masukan Harga Jual" value="<?php echo $row['harga_jual']?>">
                                       </div>
                                       <div class="form-group">
                                          <label>Stok</label>
                                          <input type="number" class="form-control" name="stok" 
                                          placeholder="Masukan Stok" value="<?php echo $row['stok']?>">
                                       </div>                        
