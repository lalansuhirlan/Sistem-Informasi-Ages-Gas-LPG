...
<?php
    ...
    $total_bayar=$_POST['total_bayar'];
      ...
      $query=mysqli_query($conn, "INSERT INTO transaksi VALUES ('','$tanggal','$kode_transaksi','$nama_produk',
      '$harga_produk','$jumlah','$total_bayar) ");
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">       
                            ...
                            <div class="form-group col-6" >
                              ...
                              <input type="text" class="form-control" name="kode_transaksi" placeholder="Masukan Kode Transaksi" required>
                            </div>
                            ...
                            <div class="form-group col-6">
                              ...
                              <input type="text" class="form-control" name="harga_produk" placeholder="Harga Produk" y>
                            </div>

                            <div class="form-group col-6" >
                              <label >Jumlah Beli</label>
                              <input type="number" class="form-control" name="jumlah" placeholder="Masukan Jumlah Beli" required>
                            </div>

                            <div class="form-group col-6">
                              <label >Total Harga</label>
                              <input type="number" class="form-control" name="total_bayar" placeholder="Total Harga">
                            </div>
                            ...
                            <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                          ...
                                          <button type="button" class="btn btn-danger" data-toggle="modal"
                                           data-target="#modal-hapus<?php echo $row['id']?>">
                                             Delete
                                           </button>
                                          </td>
                                        ...
                                        <div class="modal fade" id="modal-edit<?php echo $row['id_transaksi']?>">
                                                ...
                                                <form action="edit.php" method="post">
                                                    <div class="card-body">
                                                      <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="id_kategori" value="<?php echo $row ['id_tranksi']?>">
                                                        <input type="text" class="form-control" name="nama_kategori" 
                                                          placeholder="masukan Kategori" value="<?php echo $row['nama_kategori']?>">
                                                      </div>
                                                      <div class="form-group">
                                                ...
                                                <form action="hapus.php" method="post">
                                                    <div class="card-body">
                                                      <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_kategori" 
                                                          placeholder="masukan Kategori" value="<?php echo $row['nama_kategori']?>" readonly>
                                                      </div>
                                ...
                                <div class="card-body">
                                 ...
                                 ` </div>
                                   ...
                                   <button type="submit" name="tambah_produk" class="btn btn-primary">Hitung</button>
                                </form>
