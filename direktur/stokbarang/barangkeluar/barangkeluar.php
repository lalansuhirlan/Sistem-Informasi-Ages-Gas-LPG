      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../barangmasuk/barangmasuk.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../barangkeluar/barangkeluar.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang Keluar</p>
                </a>
              </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example2" width="100%" cellspacing="0">
                                    ...
                                    <?php
                                      ...
                                      <div class="modal fade" id="modal-hapus<?php echo $row['id_stok']?>">
                                        <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                            <!-- form start -->
                                            <form action="hapuskeluar.php" method="post">
                                            <div class="card-body">
                                                <div class="form-group">
  ...
  <div class="modal fade" id="modal-default">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                  <!-- form start -->
                  <form action="tambahkeluar.php" method="post">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="exampleInputPassword1">jenis Stok</label>
                          <input type="text" class="form-control" name="jenis_stok" placeholder="Masukan Jenis Stok">
                        </div>
                      </div>
                      <!-- /.card-body -->
