<?php
    ...
    if (isset($_POST['tambah_pengguna'])) {
      ...
      $query=mysqli_query($conn, "INSERT INTO pengguna VALUES('','$nama','$username','$password','$level') ");
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../stokbarang/barangmasuk.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../stokbarang/barangkeluar.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Barang Keluar</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../laporan/laporanpenjualan/laporanpenjualan.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan Penjualan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../laporan/laporanbarangmasuk/laporanmasuk.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan Stok Masuk</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../laporan/laporanbarangkeluar/laporankeluar.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
    ...
    <div class="container-fluid">
      <div class="card shadow mb-4">
        <div class="card-header">
         <a href="pengaturan.php" type="button" class="btn btn-danger" >
            Kembali
          </a>
          <hr>
            <form method="post" action="">
              ...
              <button type="submit" name="tambah_pengguna" class="btn btn-primary">Submit</button>
            </form>
         </div>
      </div>
    </div>
